...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Receipt.date'
        db.alter_column('reception_receipt', 'date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 13, 0, 0)))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Receipt.date'
        db.alter_column('reception_receipt', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
