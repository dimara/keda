...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for r in orm.Reservation.objects.all():
            k = orm.Keda(res_type=r.res_type, telephone=r.telephone, book_ref=r.book_ref, reservation=r)
            k.save()


    def backwards(self, orm):
        # Deleting model 'Keda'
        for k in orm.Keda.objects.all():
            r = k.reservation
            r.res_type = k.res_type
            r.telephone = k.telephone
            r.book_ref = k.book_ref
            r.save()
