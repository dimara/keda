...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('reception_reservation', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reception.MilitaryPerson']))
        # Adding field 'Person.ident'
        db.add_column('reception_person', 'ident',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Reservation.owner'
        db.alter_column('reception_reservation', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reception.Person']))
        # Deleting field 'Person.ident'
        db.delete_column('reception_person', 'ident')
