...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Keda'
        db.create_table('reception_keda', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('info', self.gf('django.db.models.fields.TextField')(max_length=100, null=True, blank=True)),
            ('res_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('telephone', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('book_ref', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('reservation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='keda', to=orm['reception.Reservation'])),
        ))
        db.send_create_signal('reception', ['Keda'])


    def backwards(self, orm):
        # Deleting model 'Keda'
        db.delete_table('reception_keda')
    ...
    models = {
        ...
        'reception.keda': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.TextField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'res_type': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'reservation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'keda'", 'to': "orm['reception.Reservation']"}),
