...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Keda.info'
        db.alter_column('reception_keda', 'info', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Keda.reservation'
        db.alter_column('reception_keda', 'reservation_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['reception.Reservation']))
        # Adding unique constraint on 'Keda', fields ['reservation']
        db.create_unique('reception_keda', ['reservation_id'])

        # Deleting field 'Reservation.telephone'
        db.delete_column('reception_reservation', 'telephone')

        # Deleting field 'Reservation.res_type'
        db.delete_column('reception_reservation', 'res_type')

        # Deleting field 'Reservation.book_ref'
        db.delete_column('reception_reservation', 'book_ref')


    def backwards(self, orm):
        # Removing unique constraint on 'Keda', fields ['reservation']
        db.delete_unique('reception_keda', ['reservation_id'])


        # Changing field 'Keda.info'
        db.alter_column('reception_keda', 'info', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'Keda.reservation'
        db.alter_column('reception_keda', 'reservation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reception.Reservation']))
        # Adding field 'Reservation.telephone'
        db.add_column('reception_reservation', 'telephone',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Reservation.res_type'
        db.add_column('reception_reservation', 'res_type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Reservation.book_ref'
        db.add_column('reception_reservation', 'book_ref',
    ...
    models = {
        ...
        'reception.keda': {
            ...
            'reservation': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'keda'", 'unique': 'True', 'to': "orm['reception.Reservation']"}),
        ...
        'reception.person': {
            'Meta': {'unique_together': "(('name', 'surname'),)", 'object_name': 'Person'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
