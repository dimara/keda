...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservation.appartment'
        db.alter_column('reception_reservation', 'appartment_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['reception.Appartment']))

    def backwards(self, orm):

        # Changing field 'Reservation.appartment'
        db.alter_column('reception_reservation', 'appartment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['reception.Appartment']))
