...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('reception_reservation', 'telephone', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    models = {
        ...
        'reception.reservation': {
            ...
            'telephone': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        'reception.staff': {
