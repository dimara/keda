...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservation.status'
        db.alter_column('reception_reservation', 'status', self.gf('django.db.models.fields.IntegerField')(max_length=20, null=True))

        # Changing field 'Reservation.res_type'
        db.alter_column('reception_reservation', 'res_type', self.gf('django.db.models.fields.IntegerField')(max_length=20, null=True))

        # Changing field 'Reservation.agent'
        db.alter_column('reception_reservation', 'agent', self.gf('django.db.models.fields.IntegerField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Reservation.status'
        db.alter_column('reception_reservation', 'status', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Reservation.res_type'
        db.alter_column('reception_reservation', 'res_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Reservation.agent'
        db.alter_column('reception_reservation', 'agent', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
