...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.unit'
        db.add_column('reception_staff', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='staff', null=True, to=orm['reception.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Staff.unit'
        db.delete_column('reception_staff', 'unit_id')
    ...
    models = {
        ...
        'reception.staff': {
            ...
            'power': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'staff'", 'null': 'True', 'to': "orm['reception.Unit']"})
        },
        'reception.unit': {
