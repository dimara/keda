...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reception_receipt', (
            ('reservation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receipts', to=orm['reception.Reservation'])),
            ('no', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('euro', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('rtype', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal('reception', ['Receipt'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Receipt'
        db.delete_table('reception_receipt')
