...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('reception_receipt', 'rtype')

        # Adding field 'Receipt.date'
        db.add_column('reception_receipt', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Receipt.pending'
        db.add_column('reception_receipt', 'pending',
    ...
    def backwards(self, orm):
        ...
        db.add_column('reception_receipt', 'rtype',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Receipt.date'
        db.delete_column('reception_receipt', 'date')

        # Deleting field 'Receipt.pending'
        db.delete_column('reception_receipt', 'pending')
