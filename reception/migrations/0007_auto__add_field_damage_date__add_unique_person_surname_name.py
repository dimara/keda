...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Damage.date'
        db.add_column('reception_damage', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Person', fields ['surname', 'name']
        db.create_unique('reception_person', ['surname', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Person', fields ['surname', 'name']
        db.delete_unique('reception_person', ['surname', 'name'])

        # Deleting field 'Damage.date'
        db.delete_column('reception_damage', 'date')
