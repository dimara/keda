...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Staff.extra'
        db.add_column('reception_staff', 'extra', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Staff.extra'
        db.delete_column('reception_staff', 'extra')
